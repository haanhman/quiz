...
#ifndef ANDROID
                    [self addSkipBackupAttributeToItemAtURL:fullPath];
#else
                    // doan nay co the khong can thiet
...
-(BOOL)addSkipBackupAttributeToItemAtURL:(NSString *)URL{
    ...
    if (&NSURLIsExcludedFromBackupKey == nil) {
        ...
        // Set the new key URLWithString
        NSError *error = nil;
        [[NSURL fileURLWithPath:URL] setResourceValue:[NSNumber numberWithBool:YES] forKey:NSURLIsExcludedFromBackupKey error:&error];
